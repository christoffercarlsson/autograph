...
Java_sh_autograph_Channel_00024Companion_autographSetKeyPairs(
  ...
  autograph_set_key_pairs((uint8_t*)identity_key_pair_elements,
...
JNIEXPORT void JNICALL
Java_sh_autograph_Channel_00024Companion_autographSetPublicKeys(
  ...
  autograph_set_public_keys((uint8_t*)identity_key_elements,
