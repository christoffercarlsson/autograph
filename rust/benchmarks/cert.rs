...
use autograph_protocol::{certify, verify, KeyPair, PublicKey, Signature};
use criterion::Criterion;

pub fn benchmark(c: &mut Criterion) {
    let our_identity_key_pair: KeyPair = [
    ...
    let their_identity_key: PublicKey = [
    ...
    let our_identity_key: PublicKey = [
