...
fn create_alice_env() -> TestEnv {
    let certificate_data: Bytes = vec![
    ...
    let certificate_identity: Bytes = vec![
    ...
    let signature_identity: Bytes = vec![
