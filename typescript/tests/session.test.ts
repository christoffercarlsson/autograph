...
describe('Session', () => {
  ...
  const messages = {
    alice: createFrom([
      0, 0, 0, 1, 205, 68, 172, 46, 75, 40, 32, 142, 127, 118, 160, 98, 203,
      206, 218, 100, 124, 111, 134, 85, 156, 22, 158, 76, 12, 167, 35
    ]),
    bob: createFrom([
      0, 0, 0, 1, 47, 156, 91, 205, 125, 20, 134, 232, 149, 227, 87, 51, 116,
      50, 206, 241, 120, 40, 93, 0, 114, 92, 39, 101, 237, 200, 115
    ])
  }
  const signatures = {
    alice: {
