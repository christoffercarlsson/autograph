if(AUTOGRAPH_TESTS)
  ...
  file(GLOB_RECURSE AUTOGRAPH_TEST_SOURCES ${CMAKE_CURRENT_SOURCE_DIR}/tests/*.cpp)
  add_executable(autograph-tests ${AUTOGRAPH_TEST_SOURCES})

  target_link_libraries(autograph-tests PRIVATE autograph
                                                Catch2::Catch2WithMain)

  target_include_directories(autograph-tests PRIVATE ${CMAKE_CURRENT_SOURCE_DIR}/include)
