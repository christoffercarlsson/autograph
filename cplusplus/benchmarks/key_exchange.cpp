...
static void key_exchange(benchmark::State &benchmarkState) {
  ...
  Autograph::KeyPair ourSessionKeyPair = {
  ...
  Autograph::PublicKey theirSessionKey = {88, 115, 171, 4,   34,  181, 120, 21,
                                          10, 39,  204, 215, 158, 210, 177, 243,
                                          28, 138, 52,  91,  236, 55,  30,  117,
                                          10, 125, 87,  232, 80,  6,   232, 93};

  Autograph::Transcript transcript;

  Autograph::Signature signature;

  Autograph::SecretKey sendingKey;

  Autograph::SecretKey receivingKey;
...
static void verify_key_exchange(benchmark::State &benchmarkState) {
  ...
  Autograph::Signature theirSignature = {
