...
bool autograph_core_ownership_certify(unsigned char *signature,
  ...
  return autograph_crypto_sign(signature, our_private_key, message.data(),
                               message.size());
}

bool autograph_core_ownership_verify(const unsigned char *their_identity_key,
